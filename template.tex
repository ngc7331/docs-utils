...
\newfontfamily\SourceHanSansCN{Source Han Sans CN}
\setCJKfamilyfont{SourceHanSansCN}{Source Han Sans CN}
\newfontfamily\SourceHanSansCNMedium{Source Han Sans CN Medium}
\setCJKfamilyfont{SourceHanSansCNMedium}{Source Han Sans CN Medium}
\newfontfamily\SourceHanSansCNBold{Source Han Sans CN Bold}
\setCJKfamilyfont{SourceHanSansCNBold}{Source Han Sans CN Bold}
...
\begin{titlepage}
  ...
  \parbox{\textwidth}
  {
    \linespread{1.3}\fontsize{48}{48}\SourceHanSansCNBold\CJKfamily{SourceHanSansCNBold}
    $title-latex$
    $if(title-line1)$
      $title-line1$
    $else$
  ...
  \parbox{\textwidth}
  {
    \fontsize{26}{26}\SourceHanSansCN\CJKfamily{SourceHanSansCN}
    $i18n-applicable$\ $replace_variables.var_processor_name$
  }
  ...
  \parbox{\textwidth}
  {
    \fontsize{14}{14}\SourceHanSansCN\CJKfamily{SourceHanSansCN}
    $version$\\
    \today
  }
